...
This example runs with just a single Pc State (as in Figure 6) and an adhesivity of 0.4.  These values may be updated as described below.  

To execute the script, run `python PcSim_1PcState_Example.py "Path\To\Save_Folder"`
...
sticky = 0.7 # Adhesive interaction between Pc-monomers. Values of ~.7 are sufficient in either the 1-state or 3-state model to create a collapsed globular 'droplet' structure.  
